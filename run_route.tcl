...
# ============================================================================
# Step 5: Generate Congestion Data for GUI Heatmap
# ============================================================================
# The routing congestion heatmap in the GUI requires congestion data
# that is generated by global_route. This data is stored in memory, not in DEF.
# Running global_route on an already-routed design will analyze the existing
# routing and generate congestion data without modifying the routing.

puts "Step 5: Generating congestion data for GUI heatmap..."
puts "  Running global_route to generate congestion data..."
puts "  Note: This analyzes the existing routing without modifying it."

# Set congestion report file path (optional, for reference)
set congestion_report_file "${build_dir}/${design_name}/${design_name}_congestion.rpt"

# Run global_route to generate congestion data in memory
# This is required for the GUI routing congestion heatmap to work
# The -allow_congestion flag allows it to work with already-routed designs
if {[catch {
    global_route \
        -allow_congestion \
    ...
    puts "  ⚠ WARNING: Global routing encountered issues: ${result}"
    puts "  The congestion heatmap may not be available in the GUI."
    puts "  Continuing anyway..."
} else {
    puts "  ✓ Congestion data generated successfully"
    puts "  ✓ Routing congestion heatmap will be available in GUI"
...
# ============================================================================
# Step 6: Launch GUI for Visualization
# ============================================================================
...
puts ""
puts "GUI Visualization Features Available:"
puts "  ✓ Routing Congestion Heatmap: Tools -> Heat Maps -> Routing Congestion"
puts "  ✓ Design Layout: View -> Layout"
puts "  ✓ Net Visualization: Select nets in the design"
puts ""
puts "Note: The routing congestion heatmap is now available because"
puts "      global_route was run to generate congestion data in memory."
puts ""
puts "To view the congestion heatmap:"
puts "  1. In the GUI, go to: Tools -> Heat Maps -> Routing Congestion"
puts "  2. The heatmap will show routing congestion across the design"
puts ""
