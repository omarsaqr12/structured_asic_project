...
![Net Histogram](build/6502/histogram_final.png)

**Insights**:
- Most nets have short HPWL (good locality)
- Long-tail distribution indicates a few critical long nets
- SA successfully reduces long net lengths more than short nets
- Distribution shift toward shorter nets confirms optimization effectiveness
